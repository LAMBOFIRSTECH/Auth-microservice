...
Authentification avec HashiCorp Vault : FAIT
...
Configurez les autorisations Vault pour que seul le serveur d’autorisation puisse lire le secret contenant la clé publique : FAIT
